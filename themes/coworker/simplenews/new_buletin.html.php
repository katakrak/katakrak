    ...
    <tr>
      <td class="center" align="center" valign="top">
        ...
        <table class="container">
          ...
          <table class="container"><!-- bloque debajo libros -->
            <tr>
              <td>
                <table class="row">
                  <tr>
                    <td class="wrapper">
                      <table class="six columns">
                        <tr>
                          <td>
                            <p class="titulo-seccion">Agenda | Egitaraua</p>
                          </td>
                        </tr>
                      </table>
                    </td>
                  ...
                  <tr>
                    ...
                    <td class="wrapper last"><!-- social table -->
                      <table class="six columns">
                        <tr>
                          <td class="panel">
          ...
          </table><!-- end bloque debajo libros -->
