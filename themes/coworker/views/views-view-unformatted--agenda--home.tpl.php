...
<div class="row ">
  <div class="col-lg-7 col-md-7">
    ...
    <div class="home-event">
      <?php print l(
      theme('image_style', array('style_name' => 'home_agenda_main_secondary', 'path' => $view->result[1]->field_field_event_image[0]['raw']['uri'])).
        '<div class="home-events-title home-events-title-main">'.
        ...
        '</div>',
      'node/'.$view->result[1]->nid, array('html' => TRUE, 'attributes' => array('class' => array('home_events_second'))));  ?>
    </div>
  </div>
  <div class="col-lg-5 col-md-5">
    <div class="home-event">
      <?php print l(
        ...
        '</div>',
        'node/'.$view->result[2]->nid, array('html' => TRUE));  ?>
    </div>
    <div class="home-event">
    <?php print l(
