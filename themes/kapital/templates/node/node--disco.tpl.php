<div class="row mt-2">
  ...
  <div class="col-sm-3">
    ...
    //Habrá que comprobar si el usuario es socixs. Por ejemplo, guardando la lista de socixs en una variable de drupal y comprobando el email. ?>
      <strong><?php echo print t('Precio Socios'); ?></strong><br />
      36 €<br />
      <strong><?php echo print t('Precio Preventa'); ?></strong><br />
      39 €<br />
      <p><?php print disco_generar_boton_product($node, "diska-aurresalmenta"); ?></p>
      <strong><?php echo print t('Precio completo, a partir del 12/12'); ?></strong><br />
      44 €<br />
