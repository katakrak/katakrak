  ...
  <div class="popup-content info">
    <div id="popup-text">
      ...
      <?php if ($disagree_button) : ?>
        <button type="button" class="find-more-button eu-cookie-compliance-more-button"><?php print t($disagree_button); ?></button>
      <?php endif; ?>
    </div>
    ...
    <div id="popup-buttons" class="<?php if ($cookie_categories) : ?>eu-cookie-compliance-has-categories<?php endif; ?>">
      <button type="button" class="<?php print $primary_button_class; ?>"><?php print t($agree_button); ?></button>
      <?php if ($secondary_button_label) : ?>
        <button type="button" class="<?php print $secondary_button_class; ?>" ><?php print t($secondary_button_label); ?></button>
      <?php endif; ?>
    </div>
  </div>
</div>
