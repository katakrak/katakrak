...
<?php print $row->field_commerce_line_items[0]['rendered']['#markup'] ?>
  fdasfdsf<p class="small mt-1"><?php print t('Forma de envio: <strong>!method</strong>', array('!method' => $row->_field_data['commerce_order_shipping_line_item_representiative_line_item_']['entity']->line_item_label ))?></p>