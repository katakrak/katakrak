<div class="d-flex-fullwidth">
  ...
  <div class="col-sm-6 col-flex bg-yellow-p" id="reservar">
    ...
    <p>
      <?php print t('Suspendisse eleifend erat sed gravida pharetra. Morbi lobortis diam nec aliquet consectetur. In hac habitasse platea dictumst.') ?>
    </p>
    <p><?php print t('Proin id diam non est aliquet egestas congue lobortis dolor. Ut lacinia dolor vel aliquet ullamcorper. Sed volutpat eleifend dui, eu dignissim lacus consectetur vitae.') ?></p>
    <p class="lead lead-hero mt-2">
      <a class="btn btn-primary" href="<?php print url('ciclos/cursos') ?>"><?php print t('Ver cursos') ?></a>
    </p>
