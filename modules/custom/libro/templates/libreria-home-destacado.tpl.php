<div class="modulo-destacado">
      <h2 class="text-center"><?php print t('¿Cómo es la compra online en Katakrak?') ?></h2>
<p class="text-center"><?php print t('Trabajamos por una compra cercana y sostenible') ?></p>
      <div class="row">
