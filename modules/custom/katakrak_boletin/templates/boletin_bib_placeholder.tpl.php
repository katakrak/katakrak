placeholder_1 <?php print $node->title ?>
placeholder_2 <?php if ($node->field_image['und'][0]['uri']): ?><?php print theme('image_style', array('style_name' => 'boletin_destacado', 'path' => $node->field_image['und'][0]['uri'])) ?><?php endif; ?><p><?php print $node->body['und'][0]['value'] ?></p><p><?php print $node->body['und'][1]['value'] ?></p>
placeholder_3 <?php foreach($node->field_boletin_bib_libros['und'] as $seccion_id): ?><?php $seccion = field_collection_item_load($seccion_id['value']);?>		
fin_placeholder_3 <?php endif; ?><?php endforeach; ?>		
placeholder_4 <?php print $seccion->field_boletin_bib_seccion['und'][0]['value'] ?>	 
placeholder_5 <?php foreach($seccion->field_boletin_libros['und'] as $i => $nid): ?><?php $libro = node_load($nid['nid']);?><?php if ($i % 2 !== 0): ?> 
placeholder_6 <a href="http://www.katakrak.net/<?php print drupal_get_path_alias('node/'.$libro->nid) ?>" ><?php print theme('image_style', array('style_name' => 'libro_boletin_bibliotecas', 'path' => $libro->field_libro_portada['und'][0]['uri'])) ?></a>
placeholder_7 <h4><a href="http://www.katakrak.net/<?php print drupal_get_path_alias('node/'.$libro->nid) ?>" ><?php print $libro->title ?></a></h4>								<h6><?php print join(', ', $libro->autores); ?></h6>								<p><?php print $libro->field_libro_isbn['und'][0]['value'] ?><br />								<?php $editorial = taxonomy_term_load($libro->field_libro_editorial['und'][0]['tid']) ?>								<?php print $editorial->name ?><br />								<?php $producto = commerce_product_load($libro->field_libro_producto['und'][0]['product_id']); $precio = commerce_currency_format($producto->commerce_price['und'][0]['amount'], $producto->commerce_price['und'][0]['currency_code']); ?>								<strong><?php print $precio ?></strong></p>								<?php if ($libro->field_libro_sinopsis['und'][0]['value']): ?>								  <p><?php print truncate_utf8($libro->field_libro_sinopsis['und'][0]['value'], 300, TRUE, TRUE) ?> <?php print l(t('[+]'), 'node/'.$libro->nid) ?></p>								<?php endif; ?>
placeholder_8 <?php else: ?>
fin_placeholder_4 <?php endforeach ?>
        ...
        <center>
          ...
          <tr>
            <td>
			  ...
			  placeholder_3
              <p class="titulo-seccion">placeholder_4</p>
                      ...
                      <tr>
						...
						<td class="wrapper">
                          <table class="eight columns">
                            <tr>
                              <td>
                                <h4><a href="http://www.katakrak.net/<?php print drupal_get_path_alias('node/'.$libro->nid) ?>" ><?php print $libro->title ?></a></h4>
								<h6><?php print join(', ', $libro->autores); ?></h6>
								<p><?php print $libro->field_libro_isbn['und'][0]['value'] ?><br />
								...
								<?php if ($libro->field_libro_sinopsis['und'][0]['value']): ?>
								  <p><?php print truncate_utf8($libro->field_libro_sinopsis['und'][0]['value'], 300, TRUE, TRUE) ?> <?php print l(t('[+]'), 'node/'.$libro->nid) ?></p>
								<?php endif; ?>
                              </td>
                              <td class="expander"></td>
                            </tr>
						...
						<td class="wrapper">
                          ...
                          <table class="four columns">
                            <tr>
                              <td>
                                <a href="http://www.katakrak.net/<?php print drupal_get_path_alias('node/'.$libro->nid) ?>" ><?php print theme('image_style', array('style_name' => 'libro_boletin_bibliotecas', 'path' => $libro->field_libro_portada['und'][0]['uri'])) ?></a>
                              </td>
                              <td class="expander"></td>
                            </tr>
                          </table>
                ...
                <tr>
                  <td class="wrapper last">
                    <table class="twelve columns">
                      <tr>
                        <td>
                          <p><?php print $node->field_boletin_body_texto['und'][0]['value'] ?></p>
                        </td>
                        <td class="expander"></td>
                      </tr>
                    </table>
