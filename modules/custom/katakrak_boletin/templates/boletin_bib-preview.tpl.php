...
<table align="center" bgcolor="#000" class="wrapper header float-center">
  <tbody>
    <tr>
                    ...
                    <tr>
                      <th class="small-6 large-6 columns first" valign="middle">
                        <table>
                          <tbody>
						    <tr>
                              <th><a href="http://www.katakrak.net"><img src="http://katakrak.net/sites/all/themes/coworker/images/logo.png"></a></th>
                            </tr>
                          </tbody>
                        </table>
                      </th>
                      <th class="small-6 large-6 columns last"  valign="bottom">
                        <table>
                          <tbody>
                            <tr>
                              <th>
                                <img style="margin-left: 15px" src="http://katakrak.net/sites/all/themes/coworker/images/boletin/hau_dena.png">
                              </th>
                            </tr>
                          </tbody>
                        </table>
  ...
  <tbody>
    <tr>
      <td>
                  ...
                  <tbody>
                    <tr>
                      <th>
						...
						<h1><?php print $node->field_titulo_euskera['und'][0]['value'] ?></h1>
                        <p class="lead"></p>
                        ...
                        <?php endif; ?>
						<p><?php print check_markup($node->body['und'][0]['value'], $node->body['und'][0]['format']) ?></p>
						-------------------------------------------------------
						<p><?php print check_markup($node->body['und'][1]['value'], $node->body['und'][1]['format']) ?></p>
						<?php if ($node->field_boletin_body_texto['und'][0]['value']): ?>
                        <table class="callout">
                          <tbody>
                            <tr>
          ...
          <tbody>
		    <tr>
              <th>
                ...
                <?php $seccion = field_collection_item_load($seccion_id['value']); $libros = $seccion->field_boletin_libros['und']; $i2 = 0 ?>
				
                <p class="titulo-seccion"><?php print $seccion->field_boletin_bib_seccion['und'][0]['value'] ?></p>
                <?php foreach($libros as $nid): ?>
                      ...
                      <tbody>
                        <tr>
                          <th class="small-4 large-4 columns first ">
                            <table>
                              <tr>
                                <th><a href="http://www.katakrak.net/<?php print drupal_get_path_alias('node/'.$libro->nid) ?>" ><?php print theme('image_style', array('style_name' => 'libro_boletin_bibliotecas', 'path' => $libro->field_libro_portada['und'][0]['uri'])) ?></a></th>
                                <th class="expander"></th>
                              </tr>
                            </table>
                          </th>
                  ...
                  <?php endif; ?><?php $i +=1; $i2 +=1; ?>
              </th>
			  <?php if ($i2 != count($seccion->field_boletin_libros['und'])): ?>
			  <table class="row linea_puntos">
                      <tbody>
                        <tr>
                          <th class="small-2 large-2 columns first "></th>
						  <th class="small-8 large-8 columns" ></th>
						  <th class="small-2 large-2 columns last "></th>
						  <th class="expander"></th>
						</tr>
				    </tbody>
					</table>
        ...
        <table align="center" class="wrapper container secondary">
          <tbody>
            <tr>
              <td class="wrapper-inner">
                <table class="spacer">
                      ...
                      <th class="small-12 large-6 columns last">
                        <table>
                          <tbody>
						    <tr>
                              <th>
							  <h4>Kontaktua | Contacto </h4>
                                <p><a href="tel:+34948225520">+34 948225520</a></p>
