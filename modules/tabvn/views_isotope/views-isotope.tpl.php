 ...
 */
?>
<div id="portfolio" class="<?php print $portfolio_style; ?>">
  <div id="portfolio-wrapper">
    <div id="isotope-container">
      ...
      <?php foreach ($rows as $id => $row): ?>
        ...
        ?>
        <div class="portfolio-item-wrapper isotope-element isotope-element-<?php print $count; ?> <?php print $classlist; ?>" data-category="<?php print $classlist; ?>" <?php print $bgstyle ?>>
